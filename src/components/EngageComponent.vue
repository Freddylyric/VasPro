<template>
    <v-main style="background: #F8FCF9;"> 
        <div class=" pl-16 pr-16 d-flex align-center justify-center" style="height:500px; ">
      ...
      <p class="par" style="color: #183B56; font-weight: 400; font-size: xx-large;">through these Interactions...</p>
                ...
                <div class="d-flex flex-column align-center mt-16" style="background: #183B56; padding: 2px; width: 532px;  height: 44px;     border-radius: 36px">
