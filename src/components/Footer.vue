  ...
  <div class="footer-bg">
    ...
    <v-footer class="footer">
      ...
      <v-row justify="space-between">
        ...
        <v-col>
          <!-- Right-end text -->
          <p class="white--text">VasPro (KE) Limited, Plot No. LR 209/2167, Crescent Lane, Parklands, Kenya operates the
            VasPro brand and is authorized and regulated by the Communications Authority of Kenya.</p>
        </v-col>
      </v-row>
    </v-footer>
